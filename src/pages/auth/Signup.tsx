    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-primary/10 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start your car care journey today</p>
        </div>
        ...
        <Card className="border-border/50 shadow-lg">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Join thousands of car owners managing their vehicles
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="receiveUpdates" className="text-sm">
                    Send me maintenance reminders and product updates
                  </Label>
                </div>
              </div>
